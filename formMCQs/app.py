...
def generate_questions():
    ...
    prompt = (f"Using the provided content, which is NCERT biology book, Create 10 (I repeat 10) NEET exam level MCQs in JSON format, keep the question level high, do not write aanything else into the response else it will cause problem in parsing the json "
